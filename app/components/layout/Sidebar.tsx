  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 p-2 rounded-lg bg-slate-900 text-white md:hidden shadow-lg transition-transform active:scale-95"
        aria-label="Toggle Menu"
      >
        {isOpen ? <CloseIcon /> : <MenuIcon />}
      </button>

      {/* Overlay for mobile - Visible only when open and below md */}
      {isOpen && (
        <div
